...
export default class NotifService {
  ...
  scheduleNotif(remindDate, remindMessage) {
    this.lastId++;
    PushNotification.localNotificationSchedule({
      date: new Date(Date.now() + remindDate), // in 30 secs
      ...
      largeIcon: 'ic_launcher', // (optional) default: "ic_launcher"
      smallIcon: 'ic_notification', // (optional) default: "ic_notification" with fallback for "ic_launcher"
      bigText: `В это время ты хотел: ${remindMessage}`, // (optional) default: "message" prop
      subText: 'Оповещание из Напоминалки :-)', // (optional) default: none
      ...
      /* iOS and Android properties */
      id: this.lastId, // (optional) Valid unique 32 bit integer specified as string. default: Autogenerated Unique ID
      title: 'Привет, я Напоминалка!', // (optional)
      message: `Привет, я Напоминалка! Открой и сделай то, что планировал)`, // (required)
  ...
  cancelNotif(idItem) {
    PushNotification.cancelLocalNotifications({id: '' + /*this.lastId*/ idItem});
  }
